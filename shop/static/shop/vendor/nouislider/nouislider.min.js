!function(t, e) {
    ...
    function vt(e) {
        ...
        Object.keys(n).forEach(function(t) {
            if (lt(e[t]) || void 0 !== i[t])
                n[t].t(r, (lt(e[t]) ? e : i)[t]);
            else if (n[t].r)
    ...
    function j(t, f, o) {
        ...
        function D(d) {
            var h = function(t) {
                ...
                if (t.mode !== st.PipsMode.Count)
                    return t.mode === st.PipsMode.Positions ? U(t.values, t.stepped) : t.mode === st.PipsMode.Values ? t.stepped ? t.values.map(function(t) {
        ...
        function O(i, o, s) {
            var t, a = x.createElement("div"), n = ((t = {})[st.PipsType.None] = "",
            ...
            return dt(a, f.cssClasses.pips),
            dt(a, 0 === f.ort ? f.cssClasses.pipsHorizontal : f.cssClasses.pipsVertical),
            Object.keys(i).forEach(function(t) {
                var e, r, n;
                r = i[e = t][0],
                n = i[t][1],
                (n = o ? o(r, n) : n) !== st.PipsType.None && ((t = P(a, !1)).className = p(n, f.cssClasses.marker),
                t.style[f.style] = e + "%",
                n > st.PipsType.NoValue && ((t = P(a, !1)).className = p(n, f.cssClasses.value),
        ...
        function _(t, e) {
            e.handle && (ht(e.handle, f.cssClasses.active),
            --v),
            e.listeners.forEach(function(t) {
                y.removeEventListener(t[0], t[1])
            }),
            0 === v && (ht(d, f.cssClasses.drag),
            Q(),
            t.cursor && (w.style.cursor = "",
            w.removeEventListener("selectstart", ut))),
        ...
        function q(t) {
            ...
            s);
            !1 !== r && (f.events.snap || ct(d, f.cssClasses.tap, f.animationDuration),
            Z(r, e, !0, !0),
            Q(),
            W("slide", r, !0),
            W("update", r, !0),
        ...
        function Z(t, e, r, n, i) {
            return !1 !== (e = i ? e : $(m, t, e, r, n, !1)) && (e = e,
            m[t = t] = e,
        ...
        function tt(t) {
            var e, r;
            l[t] && (r = 100,
            e = "translate(" + G(K(e = (e = 0) !== t ? m[t - 1] : e, r = (r = t !== l.length - 1 ? m[t] : r) - e) + "%", "0") + ")",
            r = "scale(" + G(r / 100, "1") + ")",
